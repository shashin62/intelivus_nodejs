...
<div class="smallboxy">
    ...
    <a href="<?php if($user_type_admin == "Main Rights"){echo 'home.php?type=0'.$psql;}else{echo "home.php?type=0".$psql;}?>"><div class="fbox" style="background:#3F9C34;"><span class="absbox"><i class="fa fa-copy"></i></span><h2><?php echo $onhold; ?></h2><div class="tip">WIP</div></div></a>
    
	<a href="<?php if($user_type_admin == "Main Rights"){echo 'home.php?type=3'.$psql;}else{echo "#";}?>"><div class="fbox" style="background:#36C4B6;"><span class="absbox"><i class="fa fa-thumbs-up"></i></span><h2><?php echo $rcomplete; ?></h2><div class="tip">Complete</div></div></a>
