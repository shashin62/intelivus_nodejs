        ...
        <input type="hidden" name="deleteKey" value="<?=$rndstring;?>" />
                ...
                <table id="dyntable" class="table table-bordered responsive">
                    ...
                    <tr>
							...
							<th class="head0">Reject</th>
                            <th class="head1">Records</th>
							<th class="head1">No Record Found</th>
				  ...
				  while($row=mysqli_fetch_array($rowrs))
				  {
                    ...
                    <tr class="<?php echo $cls;?>">
                            ...
                            <td class="center"><?php echo $onhold; ?></td> 
                            <td class="center"><?php echo $row['rsave']; ?></td> 
                             <td class="center"><?php echo $row['submitqa']; ?></td> 
                              <td class="center"><?php echo $row['complete']; ?></td>
						<td class="center"><?php echo $row['reject']; ?></td>
						<td ><?php echo $row["records"]; ?></td>
						<td ><?php echo $row["nrf"]; ?></td>
							<td><a href="exportdata.php?id=<?php echo $row["cid"]; ?>"><img width="16" height="16" alt="Edit" src="img/icons/export.png"></a></td>
						<td ><?php echo $act; ?></td>
						...
						if (count($InfoArray["PAGE_NUMBERS"])>1)
	 					{
							for($i=0; $i<count($InfoArray["PAGE_NUMBERS"]); $i++) 
							{
								...
								{
								?>
                                <a href="#" class="paginate_active btn-primary" style="font-weight:bold;" tabindex="0"><?=$InfoArray["PAGE_NUMBERS"][$i];?></a>
							 <?php							
								}
								else
								{
