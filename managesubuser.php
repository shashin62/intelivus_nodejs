 ...
 <table id="dyntable" class="table table-bordered responsive"  >
    ...
    <tbody>
      ...
      <tr class="<?php echo $cls;?>">
		...
		<td><?php echo $row["qareject"]; ?></td>
		  <td><?php echo $row["qareject"]+$row["complete"]+$row["rsave"]+$row["rqacount"]; ?></td>
  ...
  <div class="toolTip tpYellow" >
    <p class="clearfix"> <img src="img/icons/light-bulb-off.png" alt="Tip!" /> <strong>No Service(s) added yet.
      <input type="button" name="sub2" value="Add New" class="formbuttonInner btn-primary" onClick="javascript:location.replace('addsubuser.php');" style="width:100px;" />
      </strong></p>
  </div>
  <?php
			 }
